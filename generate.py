...
def generate(args):
    ...
    from models import dyAbITF

    model_itf = dyAbITF.load_from_checkpoint(args.ckpt,strict = False)
    ...
    # load test set
    test_set = E2EDataset(args.test_set, cdr=cdr_type, use_af2ag = args.use_af2ag)

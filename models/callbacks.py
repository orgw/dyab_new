...
from .utils import check_dir, collect_env, print_log, output_namespace


class SetupCallback(Callback):
    def __init__(self, prefix, setup_time, save_dir, ckpt_dir, args, argv_content=None):
        super().__init__()
        self.prefix = prefix
    ...
    def on_fit_start(self, trainer, pl_module):
        ...
        if trainer.global_rank == 0:
            ...
            check_dir(osp.join(self.save_dir, 'results/'))
            # setup log
...
class EpochEndCallback(Callback):
    ...
    def on_validation_epoch_end(self, trainer, pl_module):
        ...
        avg_val_loss = trainer.callback_metrics.get('valid_loss')
